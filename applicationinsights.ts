...
import AutoCollectHttpDependencies = require("./AutoCollection/HttpAIDependencyCollector");
import AutoCollectServerRequests = require("./AutoCollection/HttpAIRequestCollector");
